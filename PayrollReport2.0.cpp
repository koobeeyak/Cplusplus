...
void printHeadingToReport(){ // This will be run at start of main to setup headers
...
void printDataToReport(string string1, double double1, double double2, double double3, double double4, double double5){
...
void printTotalsLineToReport(double double1, double double2, double double3, double double4, int int1){
...
int main(){
	...
	while (employeeObject.getEmployeeName() != "DONE"){ // DONE is sentinal value
        ...
        printDataToReport(employeeObject.getEmployeeName(), hourlyRate, hoursWorked, overTimeHours, overTimeSalary, employeesSalary);
	...
	printTotalsLineToReport(totalHours, totalOvertimeHours, totalOvertimeSalary, totalSalary, count);
